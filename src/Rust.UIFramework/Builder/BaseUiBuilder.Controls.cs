...
public partial class BaseUiBuilder
{
    ...
    {
        UiPaginator control = UiPaginator.Create(this, parent, grid, currentPage, maxPage, fontSize, textColor, buttonColor, activePageColor, command, disabledColorMultiplier);
        AddControl(control);
        return control;
    }
    #endregion
