...
public partial class UiLabel : IUiLabelTrackable
{
	...
	public Oxide.Ext.UiFramework.UiElements.UiReference PlaceholderFor { get => Text.PlaceholderFor; set => Text.PlaceholderFor = value; }
	public int FontSize { get => Text.FontSize; set => Text.FontSize = value; }
	public string Font { get => Text.Font; set => Text.Font = value; }
	public UnityEngine.TextAnchor Align { get => Text.Align; set => Text.Align = value; }
	public string TextValue { get => Text.Text; set => Text.Text = value; }
	public UnityEngine.VerticalWrapMode VerticalOverflow { get => Text.VerticalOverflow; set => Text.VerticalOverflow = value; }
	public float FadeIn { get => Text.FadeIn; set => Text.FadeIn = value; }
	public Oxide.Ext.UiFramework.Colors.UiColor Color { get => Text.Color; set => Text.Color = value; }
