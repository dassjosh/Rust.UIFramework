...
public class UiElementGenerator : IIncrementalGenerator
{
    ...
    private string GenerateElement(INamedTypeSymbol classSymbol, GeneratorData genData)
    {
        ...
        // sb.AppendLine();
        //
        // sb.Append($"public partial class {classSymbol.Name}");
        // sb.Append($" : {genData.ClassSymbol.GetTrackableInterface()}");
        // sb.AppendLine();
        //
        // sb.AppendLine("{");
        //
        ...
        // {
        //     sb.AppendLine($"\tprivate readonly {genData.TrackedType.Construct(data.Type)} {data.Name.ToPrivateField()} = new({data.GetPropertyDefaults()});");
        // }
        //
        // sb.AppendLine();
        //
        ...
        //     if (data.IsTracked)
        //     {
        //         sb.AppendLine($"\tpublic {data.TypeName} {data.Name} {{ get => {data.Name.ToPrivateField()}.Value; set => {data.Name.ToPrivateField()}.Value = value; }}");
        //         continue;
        //     }
        //     
        //     if (data.ComponentPropertyTargetType is PropertyTargetType.Self)
        //     {
        //         sb.AppendLine($"\tpublic {data.TypeName} {data.Name} {{ get; set; }}");
        //         continue;
        //     }
        //     
        //     string methodCall = data.ComponentPropertyTargetType is PropertyTargetType.Method ? "()" : "";
        //     string target = !string.IsNullOrEmpty(data.ComponentPropertyTarget) ? $"{data.ComponentPropertyTarget}{methodCall}" : genData.ComponentFieldName;
        //     string property = !string.IsNullOrEmpty(data.ChildComponentPropertyName) ? data.ChildComponentPropertyName : data.Name;
        //     
        //     sb.AppendLine($"\tpublic {data.TypeName} {data.Name} {{ get => {target}.{property}; set => {target}.{property} = value; }}");
        // }
        //
        // sb.AppendLine();
        //
        ...
        // foreach (PropertyData data in genData.Properties.Where(p => p.IsTracked))
        // {
        //     sb.AppendLine($"\t{genData.TrackedType.Construct(data.Type)} {genData.ClassSymbol.GetTrackableInterface()}.{data.Name} => {data.Name.ToPrivateField()};");
        // }
        //
        // sb.AppendLine();
        //
        ...
        // {
        //     sb.AppendLine($"\t{genData.ComponentField.Type.GetTrackableInterface()} {genData.ClassSymbol.GetTrackableInterface()}.{genData.ComponentField.Name} => {genData.ComponentFieldName}.AsTrackable();");
        //     sb.AppendLine($"\tpublic {genData.ClassSymbol.GetTrackableInterface()} AsTrackable() => this;");
        // }
        //
        // sb.AppendLine();
        //
        // //Create Builder Methods
        // if (!genData.SkipBuilder)
        // {
        //     foreach (PropertyData data in genData.Properties)
        //     {
        //         if (data.SkipBuilder)
